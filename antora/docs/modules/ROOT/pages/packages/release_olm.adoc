...
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/olm/olm.rego#L290[Source, window="_blank"]
...
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/olm/olm.rego#L323[Source, window="_blank"]
...
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/olm/olm.rego#L220[Source, window="_blank"]
...
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/olm/olm.rego#L190[Source, window="_blank"]
...
* https://github.com/conforma/policy/blob/{page-origin-refhash}/policy/release/olm/olm.rego#L250[Source, window="_blank"]
...
Check the input image for the presence of related images. Ensure the images for the presence of unpinned image references
