...
* xref:release_policy.adoc#trusted_artifacts__valid_trusted_artifact_inputs[Trusted Artifacts: Trusted Artifact produced in pipeline]
* xref:release_policy.adoc#trusted_artifacts__valid_trusted_artifact_chain[Trusted Artifacts: Valid Trusted Artifact chain]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L111[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L87[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L161[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L141[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L58[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L118[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L142[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L94[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L190[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L164[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L62[Source, window="_blank"]
...
== link:#trusted_artifacts_package[Trusted Artifacts]

Trusted Artifacts ensure that only trusted Tasks were used from the origin of the source code to the produced image. The chain is constructed by linking specific parameters with results -- ones that are named `*_ARTIFACT` and have values in the form of `sha-256:<digest>`. If a chain of same-valued digests can be formed from the first Task result to the last Task by correlating the digest values of those and any tasks inbetween.
Trusted Tasks should be producing and using only the files with the same digest. Given this assurance any code injection should be detected by observing a modified digest.
This allows addition of Tasks on the Pipeline that do not need to be trusted, i.e. custom tasks.

* Package name: `trusted_artifacts`
* Package full path: `policy.release.trusted_artifacts`

[#trusted_artifacts__valid_trusted_artifact_inputs]
=== link:#trusted_artifacts__valid_trusted_artifact_inputs[Trusted Artifact produced in pipeline]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_artifacts.rego#L70[Source, window="_blank"]

[#trusted_artifacts__valid_trusted_artifact_chain]
=== link:#trusted_artifacts__valid_trusted_artifact_chain[Valid Trusted Artifact chain]

The chain of Trusted Artifacts from the origin of the first artifact to the built artifact flows through trusted Tasks.

*Solution*: Audit the pipeline to make sure no untrusted Tasks were added to the artifact-producing chain of Tasks.

* Rule type: [rule-type-indicator failure]#FAILURE#
* FAILURE message: `Code tampering detected, untrusted task %q was included in build chain comprised of: %s`
* Code: `trusted_artifacts.valid_trusted_artifact_chain`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_artifacts.rego#L29[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_task.rego#L40[Source, window="_blank"]
...
* Effective from: `2024-05-07T00:00:00Z`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_task.rego#L81[Source, window="_blank"]
...
* Effective from: `2024-05-07T00:00:00Z`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_task.rego#L60[Source, window="_blank"]
