...
* xref:release_policy.adoc#attestation_task_bundle__task_ref_bundles_not_empty[Task bundle checks: Task bundle references not empty]
* xref:release_policy.adoc#attestation_task_bundle__tasks_defined_in_bundle[Task bundle checks: Tasks defined using bundle references]
...
* xref:release_policy.adoc#attestation_task_bundle__trusted_bundles_provided[Task bundle checks: A trusted Tekton bundles list was provided]
* xref:release_policy.adoc#attestation_task_bundle__task_ref_bundles_not_empty[Task bundle checks: Task bundle references not empty]
* xref:release_policy.adoc#attestation_task_bundle__task_ref_bundles_pinned[Task bundle checks: Task bundle references pinned to digest]
* xref:release_policy.adoc#attestation_task_bundle__task_ref_bundles_trusted[Task bundle checks: Task bundles are in trusted tasks list]
* xref:release_policy.adoc#attestation_task_bundle__task_ref_bundles_current[Task bundle checks: Task bundles are latest versions]
* xref:release_policy.adoc#attestation_task_bundle__tasks_defined_in_bundle[Task bundle checks: Tasks defined using bundle references]
...
* xref:release_policy.adoc#trusted_task__current[Trusted Task checks: Current]
* xref:release_policy.adoc#trusted_task__data[Trusted Task checks: Data]
* xref:release_policy.adoc#trusted_task__pinned[Trusted Task checks: Pinned]
* xref:release_policy.adoc#trusted_task__trusted[Trusted Task checks: Trusted]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/attestation_type.rego#L72[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/attestation_type.rego#L37[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/attestation_type.rego#L54[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/cve.rego#L117[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/cve.rego#L142[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/cve.rego#L91[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/labels.rego#L17[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/labels.rego#L104[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/labels.rego#L74[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/labels.rego#L130[Source, window="_blank"]
...
[#redhat_manifests__redhat_manifests_missing]
=== link:#redhat_manifests__redhat_manifests_missing[Missing Red Hat manifests]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/redhat_manifests.rego#L14[Source, window="_blank"]
...
* Effective from: `2024-05-04T00:00:00Z`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/source_image.rego#L49[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/attestation_task_bundle.rego#L126[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/attestation_task_bundle.rego#L40[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/attestation_task_bundle.rego#L103[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/attestation_task_bundle.rego#L80[Source, window="_blank"]
...
Enterprise Contract expects that a set of tasks were included in the pipeline build for each image to be released. This package includes a set of rules to verify that the expected tasks ran in the pipeline when the image was built. Expected tasks for a pipeline are specified in a configuration file provided at runtime. This file features two primary sections: pipeline-required-tasks and required-tasks and the tasks are listed by the names given to them within the Tekton Bundle image. The pipeline-required-tasks section lists tasks specific to particular pipelines, while required-tasks details a default or baseline set of tasks. If your pipeline corresponds to an entry under pipeline-required-tasks, those tasks will be prioritized; otherwise, the system will default to the tasks listed under required-tasks. Optionally invocation parameter of a Task can be also mandated by including the name and the value in square brackets following the name of the task. For example: ``name[PARAM=val]``. Only single parameter is supported, to assert multiple parameters repeat the required task definition for each parameter seperately.
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L101[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L77[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L151[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L203[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L24[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L131[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L180[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L48[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/tasks.rego#L230[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L117[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L93[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L189[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L163[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L61[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L212[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L15[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/test.rego#L39[Source, window="_blank"]
...
=== link:#trusted_task__current[Current]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_task.rego#L42[Source, window="_blank"]

[#trusted_task__data]
=== link:#trusted_task__data[Data]
...
* Effective from: `2024-05-07T00:00:00Z`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_task.rego#L87[Source, window="_blank"]
...
* Effective from: `2024-05-07T00:00:00Z`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_task.rego#L17[Source, window="_blank"]

[#trusted_task__trusted]
=== link:#trusted_task__trusted[Trusted]
...
* Effective from: `2024-05-07T00:00:00Z`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/trusted_task.rego#L64[Source, window="_blank"]
