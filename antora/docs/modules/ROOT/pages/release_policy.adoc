...
* xref:release_policy.adoc#hermetic_pre_build_script__pre_build_script_hermetic[Hermetic pre-build-script task: Pre-Build-Script task called with hermetic param set]
...
[#hermetic_pre_build_script_package]
== link:#hermetic_pre_build_script_package[Hermetic pre-build-script task]

This package verifies the pre-build-script task in the attestation was invoked with the expected parameters to perform a hermetic build.

* Package name: `hermetic_pre_build_script`

[#hermetic_pre_build_script__pre_build_script_hermetic]
=== link:#hermetic_pre_build_script__pre_build_script_hermetic[Pre-Build-Script task called with hermetic param set]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/hermetic_pre_build_script/hermetic_pre_build_script.rego#L15[Source, window="_blank"]
