...
* Effective from: `2024-09-01T00:00:00Z`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/olm/olm.rego#L257[Source, window="_blank"]
...
*Solution*: Ensure all related images are available. Use oras discover to find the set of related images.
...
* Effective from: `2024-08-15T00:00:00Z`
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/olm/olm.rego#L216[Source, window="_blank"]
