...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/labels.rego#L148[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/labels.rego#L211[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/labels.rego#L193[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/labels.rego#L174[Source, window="_blank"]
...
== link:#rhtap_jenkins_package[RHTAP Jenkins Pipeline Build Checks]

Some initial checks for images built using an RHTAP Jenkins pipeline. Note that the RHTAP Jenkins pipeline is WIP currently, but will be shipped in an upcoming release of RHTAP. This is bare-bones currently but it's expected more useful checks will be added later. RHTAP Jenkins pipelines are defined in https://github.com/redhat-appstudio/tssc-sample-templates/tree/main/skeleton/ci
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/rhtap_jenkins.rego#L37[Source, window="_blank"]
...
* https://github.com/enterprise-contract/ec-policies/blob/{page-origin-refhash}/policy/release/rhtap_jenkins.rego#L18[Source, window="_blank"]
