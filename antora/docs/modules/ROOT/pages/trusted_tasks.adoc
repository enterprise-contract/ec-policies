...
Konflux supports two mechanisms for ensuring secure and compliant task execution in build pipelines:

1. Using a Trusted Task List.
2. Sharing files securely between tasks via Trusted Artifacts.
...
* Trusted Tasks List ensures a time-based, curated task approval system.

* Trusted Artifacts provide a flexible and secure way to share files in pipelines, enabling task customization without sacrificing supply chain integrity.
